  ...
  <div class="col m9 s12">
    ...
    if(have_posts()){
      ...
      <div class="center nav-posts" <?php post_class(); ?>>
          ...
          <?php previous_post_link('<p class="waves-effect '.$dir.'">%link</p>', __( 'Previous: ', 'materialized-wp' ) . '%title', TRUE); ?>
          <?php next_post_link( '<p class="waves-effect '.$dir1.'">%link</p>', __( 'Next: ', 'materialized-wp' ) . '%title', TRUE ); ?>
      </div>
      <br>
        <div class="article">
          ...
          <div class="post-content">
            <h3><?php the_title(); ?></h3>
              ...
              <?php the_time('j F, Y'); _e(' at ', 'materialized-wp'); the_time('G:i'); ?> | <?php _e("Posted in", 'materialized-wp') ?>:
              <?php
            ...
            <div class="the_content">
              <p class="">
                ...
                <p>
                  <?php
                  if(has_tag()){
                    _e('Tagged with: ', 'materialized-wp');
                ...
                <!-- Scial Media -->
                <p>
                  <?php _e('Share this: ', 'materialized-wp'); ?><br>
      ...
      <div class="container">
      <?php echo __("Post not found!", "materialized-wp"); ?>
      </div>
    <?php } ?>
  </div>
