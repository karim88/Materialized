<div class="col m6 s12 grid-item">
  <div class="card">
    ...
    <div class="card-content">
      ...
      <?php the_time('j F, Y'); _e(' at ', 'materialized-wp'); the_time('G:i'); ?> | <?php _e('By', 'materialized-wp') ?>: <a href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><?php the_author(); ?></a> | <?php _e("Posted in", 'materialized-wp') ?>:
      <?php
    ...
    <div class="card-action blue">
      <?php $dir = (!is_rtl())? 'right' : 'left'; ?>
       <a class="white-text read-more waves-effect blue btn-flat" href="<?php the_permalink(); ?>"><?php _e( 'Read More', 'materialized-wp' ); ?></a><a class="white-text <?php echo $dir; ?>" href="<?php echo get_comment_link() ?>"><i class="material-icons">comment</i>
