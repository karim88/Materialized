  ...
  <div class="card-panel blue darken-4 waves-effect waves-block">
    ...
    <div class="card-action">
      <?php $dir = (!is_rtl())? 'right' : 'left'; ?>
       <a class="white-text read-more waves-effect waves-light blue darken-4 btn-flat" href="<?php the_permalink(); ?>"><?php _e( 'Read More', 'materialized-wp' ); ?></a><a class="white-text <?php echo $dir; ?>" href="<?php echo get_comment_link() ?>"><i class="material-icons">comment</i>
